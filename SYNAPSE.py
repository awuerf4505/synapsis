...
while not done:
    ...
    if stage == PLAYING:
         if player[0] < 0 or player[0] > 1175 or \
           player[1] < 0 or player[1] > 625:
            stage = END
    if stage == PLAYING:
         if enemy[0] < 0 or enemy[0] > 1175 or \
           enemy[1] < 0 or enemy[1] > 625:
            stage = END
    ...
    if stage == START:
        ...
        text2 = MY_FONT.render("Your Score Was: " + str(score), True, WHITE)
        text3 = MY_FONT.render("Press SPACE to restart.", True, WHITE)
        screen.blit(text1, [25, 350])
        screen.blit(text2, [25, 400])
        screen.blit(text3, [25, 450])
